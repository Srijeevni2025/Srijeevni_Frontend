...
const Home = () => {
  ...
  return (
    <Base>
      ...
      {showPrescriptionUpload && (<PrescriptionUpload showPrescriptionUpload = {showPrescriptionUpload} setShowPrescriptionUpload={setShowPrescriptionUpload}/>)}
      ...
      <div className='relative z-0'>
        ...
        <div className='px-14'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-3 border-2 border-emerald-300 rounded-xl overflow-hidden contrast-150'>
            ...
            <div className='sm:col-span-1 flex flex-col sm:flex-row justify-center gap-4 sm:gap-8 p-6 sm:p-8 bg-emerald-300'>
              ...
              <div className='my-auto text-center'>
                ...
                <div className='flex justify-center'>
                  ...
                  <button type='button' className='px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl contrast-120  transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500' onClick = {()=>{setShowPrescriptionUpload(()=>!showPrescriptionUpload)}}>Select Files</button>
                ...
                {prescriptionData.map((curEle, index) => {
                  ...
                  return (
                    ...
                    <p key={index} className={`flex items-center sm:row-start-${row} sm:col-start-${col}`}>
                      ...
                      <span className='px-3 py-1 bg-emerald-400 text-xl text-white rounded-lg contrast-150'>{id}</span>
        ...
        <div className='px-14 py-16 flex flex-wrap justify-between gap-4'>
          ...
          {specialFeatureData.map((curEle, index) => {
            ...
            return (
              <div className={`w-80 p-4 flex justify-between ${bg_color} ${bg_hover} rounded-xl cursor-pointer shadow-2xl  contrast-150 transition-transform duration-200 hover:-translate-y-1 hover:scale-110 `} key={index}>
        ...
        <div className='flex justify-center '>
          ...
          <div className='px-8 py-2 flex justify-center gap-8 border-3 border-red-500 rounded-xl transition-transform duration-200 hover:-translate-y-1 hover:scale-110 hover:shadow-lg'>
        ...
        <div className='my-16 bg-gradient-to-r from-[#89D5B6] via-[#54C295] to-[#2E8B70] contrast-150'>
                ...
                {popularTestData.map((curEle, index) => {
                  ...
                  return (
                    <div className='cursor-pointer' key={index}>
                      ...
                      <img src={image} alt={message} className='h-44 w-48 rounded-xl object-cover transform transition-transform duration-300 hover:scale-110' />
                ...
                return (
                  <div className='cursor-pointer' key={index}>
                    ...
                    <div className='flex justify-center'>
                      ...
                      <div className='flex justify-center items-center h-24 w-24 bg-[#93D6FC] rounded-full transform transition-transform duration-300 hover:scale-110'>
